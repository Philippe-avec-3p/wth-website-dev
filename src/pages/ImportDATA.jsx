...
const ImportDATA = () => {
    return (
        ...
        >
            ...
            <h1 className="text-center top-text mt-4">ESGA</h1>
            ...
            <div className="subsection container mt-5">
                ...
                <div className="row justify-content-center align-items-center">
                    ...
                    <div className="col-md-6">
                        <img src="/assets/img/logicielicon7.jpg" alt="Support informatique" className="img-fluid " />
                ...
                <div className="row justify-content-center align-items-center mt-4">
                    <div className="col-md-6">
                        <img src="/assets/img/logicielicon8.jpg" alt="Approche proactive" className="img-fluid rounded shadow-lg" />
                    </div>
                    <div className="col-md-6">
                        <div className="p-4">
