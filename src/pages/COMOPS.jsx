...
const COMOPS = () => {
    return (
        ...
        >
            ...
            <h1 className="text-center top-text mt-4">COMOPS</h1>
            ...
            <div className="subsection container mt-5">
                ...
                <div className="row justify-content-center align-items-center">
                    ...
                    <div className="col-md-6">
                        <img src="/assets/img/logicielicon1.jpg" alt="Support informatique" className="img-fluid " />
                ...
                <div className="row justify-content-center align-items-center mt-4">
                    <div className="col-md-6">
                        <img src="/assets/img/logicielicon2.jpg" alt="Approche proactive" className="img-fluid rounded shadow-lg" />
                    </div>
                    <div className="col-md-6">
                        <div className="p-4">
